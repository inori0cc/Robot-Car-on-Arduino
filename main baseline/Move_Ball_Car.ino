...
ServoTimer2 myServo,myServo2;           //声明舵机
#define Forward_Left_Speed 95  //小车前进时左轮速度
#define Forward_Right_Speed 135//小车前进时右轮速度
#define Back_Left_Speed 95    //小车后退时左轮速度
#define Back_Right_Speed 135   //小车后退时右轮速度
#define Left_Left_Speed 95   //小车左转时左轮速度 95
#define Left_Right_Speed 170   //小车左转时右轮速度 205
#define Right_Left_Speed 155   //小车右转时左轮速度165
#define Right_Right_Speed 185  //小车右转时右轮速度 135
...
int servo_num = 2;//定义舵机数量
int servo_port = 4;//定义舵机引脚
int servo_port2 = 7;//定义舵机引脚
float value_init = 65;//定义舵机初始角度
float value_init2 = 140;//定义舵机初始角度
float f_value_init = 160;//定义舵机末角度
float f_value_init2 = 20;//定义舵机末角度
